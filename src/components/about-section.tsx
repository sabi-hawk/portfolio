    ...
    <section id="about" className="bg-[#fafafa] py-[12rem] md:py-[8rem]">
      <div className="max-w-[120rem] mx-auto w-[92%]">
        <div className="mb-[9rem] md:mb-[8rem]">
          <span className="block text-[4rem] uppercase tracking-[3px] text-center mb-[3.5rem] relative text-[#111] font-bold
        ...
        <div className="grid grid-cols-[1fr_1fr] gap-[10rem] md:grid-cols-[1fr] md:gap-[8rem]">
          <div>
            <h3 className="text-[2.8rem] font-[700] mb-[3rem] md:text-[2.4rem]">Get to know me!</h3>
            <div>
          ...
          <div>
            <h3 className="text-[2.8rem] font-[700] mb-[3rem] md:text-[2.4rem]">My Skills</h3>
