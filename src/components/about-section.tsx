...
export function AboutSection() {
  return (
    <section id="about" className="bg-[#fafafa] py-[12rem] xl:py-[8rem]">
      <div className="max-w-[120rem] mx-auto w-[92%]">
        <div className="mb-[9rem] xl:mb-[8rem]">
          <span
            ...
            xl:after:top-[calc(100%+1.2rem)]"
          >
            About Me
          </span>
          <span className="block text-center text-[#555] text-[2rem] font-[500] max-w-[80rem] mx-auto leading-[1.6] xl:text-[1.8rem]">
            Here you will find more information about me, what I do, and my
            current skills mostly in terms of programming and technology
          </span>
        </div>
        <div className="grid grid-cols-2 gap-[5rem] 2xl:grid-cols-2 xl:grid-cols-1 xl:gap-[8rem]">
          <div className="max-w-[60rem]">
            <h3 className="text-[2.8rem] font-[700] mb-[3rem] xl:text-[2.4rem]">
              Get to know me!
            </h3>
            <div>
              <p className="text-[1.8rem] text-[#666] leading-[1.7] mb-[1rem]">
              ...
              <p className="text-[1.8rem] text-[#666] leading-[1.7] mb-[4rem]">
            ...
            <a
              href="#contact"
              className="bg-[#7843E9] text-[#ffffff] uppercase tracking-[1px] inline-block font-[700] rounded-[5px] 
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-[1rem]">
              {skills.map((skill) => (
                <div
                  key={skill}
                  className="px-[2rem] py-[1rem] text-[1.6rem] 
