        ...
        <div className="py-[25rem] max-w-[90rem] w-[92%] mx-auto md:py-[19rem]">
          ...
          <div className="mt-[3rem] mx-auto max-w-[80rem]">
            <p className="text-[2.2rem] text-[#333] text-center w-full leading-[1.6] md:text-[2rem]">
              A complete, ready-to-launch educational SaaS with customizable
              Student, Teacher, and Admin portals. Institutions can select only
              the features they need, set up their own branded system in
              minutes, and launch a professional, scalable platform without
              custom development.
            </p>
          </div>
          <div className="mt-[5rem] text-center">
            <a
              href="https://github.com/sabi-hawk/dynamic-portal"
        ...
        <div className="max-w-[90rem] mx-auto">
          <div className="w-full mb-[6rem] grid grid-cols-1 md:grid-cols-2 gap-[2rem]">
            <img
              ...
              alt="EduNexus Screenshot 1"
              className="w-full rounded-lg"
            />
            <img
              src="/screenshots/edu-nexus-2.png"
              alt="EduNexus Screenshot 2"
              className="w-full rounded-lg"
            />
            <img
              src="/screenshots/edu-nexus-3.png"
              alt="EduNexus Screenshot 3"
              className="w-full rounded-lg"
            />
            <img
              src="/screenshots/edu-nexus-4.png"
              alt="EduNexus Screenshot 4"
              className="w-full rounded-lg"
            />
          </div>
          <div className="w-full max-w-[70rem] mx-auto">
            <div className="mb-[7rem]">
              ...
              <p className="text-[1.8rem] leading-[1.7] text-[#666] mb-[2rem]">
                EduNexus offers a complete, ready-to-launch educational solution
                featuring three customizable portals: Student, Teacher, and
                Admin. Users can easily purchase the portals they need and
                select only the features relevant to their institution, keeping
                the system lean, efficient, and cost-effective.
              </p>
              <p className="text-[1.8rem] leading-[1.7] text-[#666] mb-[2rem]">
                Designed for maximum flexibility and ease of use, the platform
                allows anyone to set up their own branded educational portal
                within minutes — no need for expensive custom development or
                contractors. Institutions simply provide their name, logo,
                primary and secondary colors, and choose their desired portals
                and features.
              </p>
              <p className="text-[1.8rem] leading-[1.7] text-[#666] mb-[2rem]">
                Whether you&apos;re setting up for a school, academy, or
                training center, this platform empowers you to launch a
                professional, fully functional system quickly and effortlessly,
