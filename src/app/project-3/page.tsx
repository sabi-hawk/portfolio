        ...
        <div className="py-[25rem] max-w-[90rem] w-[92%] mx-auto md:py-[19rem]">
          ...
          <div className="mt-[3rem] mx-auto max-w-[80rem]">
            <p className="text-[2.2rem] text-[#333] text-center w-full leading-[1.6] md:text-[2rem]">
              A unified web platform for client engagement, growth strategies, and business management. ATOM integrates lead generation, email tools, real-time chat, AI, analytics, and more into a single user-friendly solution.
            </p>
          </div>
      ...
      <section className="py-[8rem]">
        <div className="max-w-[90rem] mx-auto">
          <div className="w-full mb-[6rem] grid grid-cols-1 md:grid-cols-2 gap-[2rem]">
            <img src="/screenshots/atoms-1.png" alt="ATOM Screenshot 1" className="w-full rounded-lg" />
            <img src="/screenshots/atoms-2.png" alt="ATOM Screenshot 2" className="w-full rounded-lg" />
            <img src="/screenshots/atoms-3.png" alt="ATOM Screenshot 3" className="w-full rounded-lg" />
            <img src="/screenshots/atoms-4.png" alt="ATOM Screenshot 4" className="w-full rounded-lg" />
          </div>
          <div className="w-full max-w-[70rem] mx-auto">
            <div className="mb-[7rem]">
              ...
              <p className="text-[1.8rem] leading-[1.7] text-[#666] mb-[2rem]">
                ATOM (Automated Task & Operations Management) is a revolutionary web-application platform designed to streamline client engagement, enhance growth strategies, and empower business developers, digital marketers, freelancers, and business owners. By unifying essential business tools, ATOM improves efficiency, reduces operational costs, and fosters business growth.
              </p>
              <h3 className="font-[700] text-[2rem] mb-[1.5rem]">Project Goals:</h3>
              <ul className="list-disc ml-[2rem] mb-[2rem] text-[1.8rem] leading-[1.7] text-[#666]">
                ...
                <li>Enhance growth strategies through integrated marketing tools.</li>
                <li>Provide a user-friendly platform that combines multiple business functions.</li>
                <li>Increase operational efficiency and reduce costs for users.</li>
                <li>Foster business development for digital marketers, freelancers, and business owners.</li>
              </ul>
              <h3 className="font-[700] text-[2rem] mb-[1.5rem]">Scope of Work:</h3>
              <ul className="list-disc ml-[2rem] mb-[2rem] text-[1.8rem] leading-[1.7] text-[#666]">
                <li>Lead Generation Utility: Niche-based lead generation capabilities.</li>
                <li>Mail Composer (Drag n Drop): User-friendly email design tool (Unlayer).</li>
                <li>Bulk Email Sender: Efficient mass email communication (Mailtrap).</li>
                <li>Mail Tracking Feature: Campaign tracking features.</li>
                <li>Dedicated Chat Rooms: Real-time client interaction (Liveblocks).</li>
                ...
                <li>Analytics: Comprehensive dashboard for campaign metrics.</li>
                <li>Subscription Plans: Tiered plans for different user needs.</li>
            ...
            <div className="mb-[7rem]">
              ...
              <div className="flex flex-wrap">
                ...
                <div className="px-[2rem] py-[1rem] mb-[1.5rem] mr-[1.5rem] text-[1.6rem] bg-[rgba(153,153,153,0.2)] rounded-[5px] font-[600] text-[#666]">Bootstrap</div>
                ...
                <div className="px-[2rem] py-[1rem] mb-[1.5rem] mr-[1.5rem] text-[1.6rem] bg-[rgba(153,153,153,0.2)] rounded-[5px] font-[600] text-[#666]">Liveblocks</div>
                <div className="px-[2rem] py-[1rem] mb-[1.5rem] mr-[1.5rem] text-[1.6rem] bg-[rgba(153,153,153,0.2)] rounded-[5px] font-[600] text-[#666]">Mailtrap</div>
                <div className="px-[2rem] py-[1rem] mb-[1.5rem] mr-[1.5rem] text-[1.6rem] bg-[rgba(153,153,153,0.2)] rounded-[5px] font-[600] text-[#666]">Unlayer</div>
                <div className="px-[2rem] py-[1rem] mb-[1.5rem] mr-[1.5rem] text-[1.6rem] bg-[rgba(153,153,153,0.2)] rounded-[5px] font-[600] text-[#666]">Redux</div>
                <div className="px-[2rem] py-[1rem] mb-[1.5rem] mr-[1.5rem] text-[1.6rem] bg-[rgba(153,153,153,0.2)] rounded-[5px] font-[600] text-[#666]">Zustand</div>
              </div>
            </div>
            <div>
              <h2 className="font-[700] text-[2.8rem] mb-[3rem] md:text-[2.4rem]">
