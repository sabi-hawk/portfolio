        ...
        <div className="py-[25rem] max-w-[90rem] w-[92%] mx-auto md:py-[19rem]">
          ...
          <div className="mt-[3rem] mx-auto max-w-[80rem]">
            <p className="text-[2.2rem] text-[#333] text-center w-full leading-[1.6] md:text-[2rem]">
              This page contains the case study of Crown Template Project which includes the Project 
              Overview, Tools Used and Live Links to the official product.
            </p>
          </div>
          <div className="mt-[5rem] text-center">
            <a href="https://github.com/sabi-hawk/crown-template" className="bg-[#7843E9] text-white uppercase tracking-[1px] inline-block font-[700] rounded-[5px] shadow-[0_5px_15px_0_rgba(0,0,0,0.15)] transition-transform hover:-translate-y-[3px] px-[8rem] py-[1.5rem] text-[2rem]" target="_blank" rel="noreferrer">
              Project Link
            </a>
          </div>
        </div>
      ...
      <section className="py-[8rem]">
        <div className="max-w-[90rem] mx-auto">
          <div className="w-full mb-[6rem]">
            <img src="/screenshots/crown-template.jpeg" alt="Project Image" className="w-full" />
          </div>
          <div className="w-full max-w-[70rem] mx-auto">
            <div className="mb-[7rem]">
              ...
              <p className="text-[1.8rem] leading-[1.7] text-[#666] mb-[2rem]">
                Crown Template is a modern and elegant template designed for businesses in the fashion and luxury goods industry. I created this template to showcase how a high-end brand can establish a strong online presence.
              </p>
              <p className="text-[1.8rem] leading-[1.7] text-[#666] mb-[2rem]">
                The template features a clean and sophisticated design with smooth animations, carefully chosen typography, and a color scheme that exudes luxury and professionalism.
              </p>
              <p className="text-[1.8rem] leading-[1.7] text-[#666] mb-[2rem]">
                The site includes essential sections such as Featured Collections, About, Lookbook, and Contact, making it perfect for fashion brands to showcase their products and connect with their audience.
              </p>
              <p className="text-[1.8rem] leading-[1.7] text-[#666] mb-[2rem]">
            ...
            <div className="mb-[7rem]">
              ...
              <div className="flex flex-wrap">
                <div className="px-[2rem] py-[1rem] mb-[1.5rem] mr-[1.5rem] text-[1.6rem] bg-[rgba(153,153,153,0.2)] rounded-[5px] font-[600] text-[#666]">HTML</div>
                <div className="px-[2rem] py-[1rem] mb-[1.5rem] mr-[1.5rem] text-[1.6rem] bg-[rgba(153,153,153,0.2)] rounded-[5px] font-[600] text-[#666]">CSS</div>
                ...
                <div className="px-[2rem] py-[1rem] mb-[1.5rem] mr-[1.5rem] text-[1.6rem] bg-[rgba(153,153,153,0.2)] rounded-[5px] font-[600] text-[#666]">Responsive Design</div>
              </div>
            </div>
            <div>
              <h2 className="font-[700] text-[2.8rem] mb-[3rem] md:text-[2.4rem]">
              ...
              <a
                href="https://github.com/sabi-hawk/crown-template"
